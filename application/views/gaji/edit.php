...
<div class="flex h-screen bg-gray-100">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <header class="bg-white shadow-sm">
            <div class="px-6 py-4">
                <h1 class="text-2xl font-semibold text-gray-800">Edit Data Gaji</h1>
            </div>
        </header>
        <main class="flex-1 overflow-y-auto bg-gray-50 p-6">
            <div class="max-w-4xl mx-auto">
                ...
                <?= form_open('gaji/edit/'.$gaji->id_krywn.'/'.$gaji->tgl_gaji, ['class' => 'bg-white rounded-lg shadow-sm']) ?>
                        ...
                        <div class="grid grid-cols-3 gap-4 items-center">
                            ...
                            <div class="col-span-2">
                                <input type="text" 
                                       ...
                                       value="<?= $gaji->nama_krywn ?>"
                                       disabled>
                                <input type="hidden" name="id_krywn" value="<?= $gaji->id_krywn ?>">
                            </div>
                        </div>
                        <div class="grid grid-cols-3 gap-4 items-center">
